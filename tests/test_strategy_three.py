...
class TestPlayer(unittest.TestCase):
    ...
    def test_strategy_three_choses_column_closest_to_win_for_blue(self):
        ...
        board = GameBoard.from_matrix([
                    ...
                    ['red', None, 'blue', None, None, None, None]])
        self.assertEqual(self.strategy_three.return_column(board, self.color), 3)
    ...
    def test_strategy_three_choses_sixth_column_because_unable_to_win_on_leftmost(self):
        ...
        self.assertEqual(6, self.strategy_three.return_column(board, self.color))

    def test_strategy_three_choses_leftmost_column_when_more_than_one_are_equal(self):
